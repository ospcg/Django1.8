...
SECRET_KEY = 'cz1x_+2yi20)34n*-shimnarrju^u!wj@y-x%w6x4mf88yh)!r'
...
TEMPLATES = [
    {        
        ...
        #Ruta que indica el nombre de la carpeta templates
...
#carpeta de recursos estaticos js, css, etc
STATICFILES_DIRS = (os.path.join(BASE_DIR, 'static'),)

#despues de loguear te envia a lista de adopciones
LOGIN_REDIRECT_URL = reverse_lazy('adopcion:solicitud_listar')
#despues de cerrar sesion
LOGOUT_REDIRECT_URL = reverse_lazy('login')

#Datos para enviar email recuperar password de usuario
EMAIL_USE_TLS = True
